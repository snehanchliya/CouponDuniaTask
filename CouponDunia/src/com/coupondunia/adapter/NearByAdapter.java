...
public class NearByAdapter extends BaseAdapter {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		viewHolder.totalOffers.setText(offer.getNumCoupons().toString()+" Offers");		
		viewHolder.categories.setText(offer.getCategoriesString());		
		viewHolder.distanceAndLocation.setText(offer.getDistance().intValue()+" m "+offer.getNeighbourhoodName());
